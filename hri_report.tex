...
\begin{comment}
THE THIRD PARAGRAPH SHOULD BE ABOUT THE OTHER FINDINGS, SLIGHTLY SHORTER\newline
\end{comment}

\begin{comment}
THE FOURTH PARAGRAPH SHOULD TALK ABOUT THE LIMITATIONS AND SHORT FALLS OF THE STUDY\newline
\end{comment}
...
\section{Conclusion}
\begin{comment}
FIRST PARAGRAPH SHOULD BE ABOUT A QUICK SUMMARY OF FINDINGS\newline
then talk about what these findings mean for the future of the field, what more work needs to be done\newline
\end{comment}

\begin{comment}
SECOND PARAGRAPH,  What is the main take-home message of your study?\newline
 What is the main contribution that your study makes to your field?\newline
 For whom are the study results important?\newline
\end{comment}
